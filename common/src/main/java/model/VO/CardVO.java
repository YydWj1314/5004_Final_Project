...
/**
 * CardVO (View Object) represents a visual card component in the GUI. It extends JLabel and can
 * display either the front or back image of a card depending on its state (face-up or face-down).
 */
public class CardVO extends JLabel {
  ...
  /**
   * Save the original Y-coordinate of the card's position. This can be used for UI animations like
   * raising/lowering selected cards.
   *
  ...
  /**
   * Turns the card face-up by setting the icon to its front image. Loads the image dynamically
