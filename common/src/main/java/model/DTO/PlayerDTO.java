...
/**
 * Data Transfer Object (DTO) for player information in the game. Used to transfer player data (such
 * as ID, name, and current hand) between server and client without exposing internal game logic.
 */
